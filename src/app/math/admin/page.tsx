      ...
      <div className="mx-auto w-full max-w-xl">
        ...
        <div className="mt-2 flex items-start justify-between gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              href="/admin"
              className="mt-1 rounded-md border border-white/10 bg-white/5 px-3 py-1.5 text-sm font-semibold text-white/70 transition hover:border-yellow-400 hover:text-yellow-400"
            >
              Analytics →
            </Link>
            <Link
              href="/math/admin/new"
              className="mt-1 rounded-md bg-yellow-400 px-3 py-1.5 text-sm font-bold text-slate-950 transition hover:bg-yellow-300"
            >
              + New lesson
            </Link>
          </div>
