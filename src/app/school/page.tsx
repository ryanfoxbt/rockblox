...
export const metadata: Metadata = buildShareMetadata({
  title: "Drum School — Learn to Play Drums Online Free",
  description:
    "A free, stepwise beginner drum curriculum on RockBlocks — 100 lessons that each add one idea, from the first steady pulse to the backbeat, kick, fills, and full song arrangements. No login or download.",
  path: "/school",
});
    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 px-4 py-10 text-white sm:px-6">
      ...
      <div className="mx-auto w-full max-w-xl">
        ...
        <p className="mt-2 text-sm text-white/50">
          A free way to learn drum beats online: {DRUM_LESSONS.length} lessons, stepwise — each one adds a single
          new idea to the last. Start at Lesson 1 even if you can already play a beat; the point is to see how a
          full groove gets built one piece at a time. Every lesson is interactive and plays in your browser —
          no login, no download, and nothing you change here saves, so everyone gets the same starting point.
        </p>
