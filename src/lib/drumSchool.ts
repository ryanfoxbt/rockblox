...
export const DRUM_LESSONS: DrumLesson[] = [
  ...
  { slug: "lesson-50-graduation-two", lessonNumber: 50, title: "Graduation II: Fifty Lessons In", teaches: "A paradiddle-based verse, a samba-influenced bridge, a driving chorus, and a fill — the advanced half, in one song." },
];
